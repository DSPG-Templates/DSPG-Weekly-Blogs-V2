...
- Adjust the author above so that the appropriate one of `"STEM Education"` or ` "Community Capitals"`.
is selected.
- Change the title of the blog to "Community Capitals Week One", adjusting for each group. The categories are case sensitive.
